                            ...
                            <div class="tab-pane active" id="settings">
                                <form class="form-horizontal" method="POST" action="{{ route( 'client.update', [ 'client' => $client['id'] ] ) }}">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control @error('rg') is-invalid @enderror" id="inputrg" placeholder="Identidade / Órgão Emissor - UF" name="rg" value="{{$client['rg']}}">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                          <textarea type="text" class="form-control @error('full_address') is-invalid @enderror" id="inputfull_address" placeholder="Endereço Completo" name="full_address">{{$client['full_address']}}</textarea>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                          <textarea type="text" class="form-control @error('obs') is-invalid @enderror" id="inputobs" placeholder="Observações" name="obs">{{$client['obs']}}</textarea>
                                      </div>
                                  </div>
